...
export default template({
  ...
  computed: {
    ...
    bulkItemAttr: function() {
      return this.bulkFieldPrefix && this.bulkFieldPrefix + "item";
    },
    bulkNameAttr: function() {
      return this.bulkFieldPrefix && this.bulkFieldPrefix + "name";
    },
    bulkName: function() {
      return this.statement[this.bulkNameAttr];
    }
  },
  created: function() {
  ...
  methods: {
    ...
    search: function(searchTerm) {
      ...
      wikidataClient
        .search(searchTerm, this.getLanguageCode(), "en")
        .then(data => {
          console.log(data);
    ...
    getLanguageCode: function() {
      return (
        localStorage.getItem(wikidataClient.page + ".language") ||
        this.languageCode
      );
    }
  }
